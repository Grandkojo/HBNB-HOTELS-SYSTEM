...
<a href="#" onclick="goBack(); return false;">
        ...
        <a href="#" onclick="goForward(); return false;">
            <i class="fa fa-arrow-right fa-2x me-3" aria-hidden="true" style="float:left; margin-left: 20px;"></i>
        </a>

    <h2 style="margin-left:em; text-align:center;"><strong>Edit Room - Admin Panel</strong></h2>
