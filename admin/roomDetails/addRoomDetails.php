                            ...
                            if (isset($_POST['aircondition'])) {
                                ...
                                if (isset($_FILES["imageFile"]) && $_FILES["imageFile"]["error"] === UPLOAD_ERR_OK) {
                                    ...
                                    if (move_uploaded_file($_FILES["imageFile"]["tmp_name"], $uploadedFilePath)) {
                                        ...
                                        //Query to check if the residence name already exists
                                        $sql1 = "SELECT * FROM room WHERE NAME = :residencename LIMIT 1";
                                        $stmt1 = $conn->prepare($sql1);
                                        $stmt1->bindParam(':residencename', $residence_name);
                                        $stmt1->execute();
