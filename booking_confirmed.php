...
$residence_name = isset($_GET['residence_name']) ? $_GET['residence_name'] : '';
// var_dump($residence_name); exit;
?>
...
<head>
    ...
    <link rel="icon" href="images/online-booking.png">
...
<body style="background-image: url(uploads/luxury/100.jpg); background-size: cover; background-repeat: no-repeat; backdrop-filter: blur(1.5px);" class="vh-100">
    ...
    <div class="container d-flex align-items-center justify-content-center mt-5">
        <form id="bookingForm" class="d-flex flex-column justify-content-center border border-danger shadow p-5 mb-5 px-5 pt-3 pb-4 border-3 bg-light rounded-3 w-40" action="phpEmail.php?residence_name=<?php echo $residence_name ?>" method="post">
            ...
            Number of occupants: <input type="number" value="1" class="form-control" name="occupants" id="occupants" placeholder="min 1, max 5" min="1" max="5" required>
